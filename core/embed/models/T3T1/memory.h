...
#define BOOTLOADER_SECTOR_END 0x19

#define STORAGE_1_START 0x0C034000
#define STORAGE_1_MAXSIZE (8 * 8 * 1024)  // 64 kB
#define STORAGE_1_SECTOR_START 0x1A
#define STORAGE_1_SECTOR_END 0x21

#define STORAGE_2_START 0x0C044000
#define STORAGE_2_MAXSIZE (8 * 8 * 1024)  // 64 kB
#define STORAGE_2_SECTOR_START 0x22
#define STORAGE_2_SECTOR_END 0x29

#define FIRMWARE_START 0x0C054000
#define FIRMWARE_MAXSIZE (206 * 8 * 1024)  // 1648 kB
#define FIRMWARE_SECTOR_START 0x2A
